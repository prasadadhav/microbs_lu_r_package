...
#     true_path <- "L:/Units & Programmes/BIOTECH/ENVMICRO/_Common/Projects/SUPERVIR/11-Results/Data_Treatment/1_check_data"

#     test_path <- set_microbs_check_DataPath()
...
#     true_path <- "D:/03_Workspace/01_R_Package/microbs_lu_dummy_data/Data_Treatment/1_check_data"

#     test_path <- set_microbs_check_DataPath(test_local_path)
