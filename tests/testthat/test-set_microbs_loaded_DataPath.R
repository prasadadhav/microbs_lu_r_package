...
# test_that("setting the custom local path for loaded data", {
...
#     test_path <- set_microbs_loaded_DataPath(test_local_path)
...
# test_that("setting the relative path for loaded data", {
...
#         test_path <- set_microbs_loaded_DataPath(test_local_path,  relative=TRUE)
